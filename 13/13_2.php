...
class FormHelperTest extends PHPUnit_Framework_TestCase {
    ...
    public $stooges = ['Larray', 'Moe', 'Curly', 'Shemp'];
    ...
    public function testAssociativeOptions() {
        ...
        <select>
            <option value="cu&amp;ke">데친 &lt;바다&gt; 해삼</option>
            <option value="stomach">"순대"</option>
            <option value="tripe">와인 소스 양대창</option>
            <option value="taro">돼지고기 토란국</option>
            <option value="giblets">곱창 소금 구이</option>
            <option value="abalone">전복 호박 볶음</option>
        </select>        
        _HTML_
        );
    }
    ...
    public function testNumericOptions() {
        ...
        $this->assertEquals($html,<<<_HTML_
        <select>
            <option value="0">Larry</option>
            <option value="1">Moe</option>
            <option value="2">Curly</option>
            <option value="3">Shemp</option>
        </select>
        _HTML_        
        );
    }
    ...
    public function testMultipleAttribute() {
        $form = new FormHelper();
        $html = $form->select([],["name" => "menu", "q" => 1, "multiple" => true]);
