...
<table>
    ...
    <? } ?>
        ...
        <tr>
            <td>State:</td>
            <td><?= $form->select($GLOBALS['states'], ['name' => 'from_state']) ?></td>
        </tr>
        <tr>
            <td>ZIP:</td>
            <td><?= $form->input('text', ['name' => 'from_zip', 'size => 5']) ?></td>
        </tr>
        ...
        <tr>
            <td>State:</td>
            <td><?= $form->select($GLOBALS['states'], ['name' => 'to_state']) ?></td>
        </tr>
        <tr>
            <td>ZIP:</td>
            <td><?= $form->input('text', ['name' => 'to_zip', 'size => 5']) ?></td>
        </tr>
        ...
        <tr>
            <td>depth:</td>
            <td><?= $form->select($GLOBALS['states'], ['name' => 'depth']) ?></td>
        </tr>
        <tr>
            <td colspan="2" align="center">ZIP:</td>
            <td><?= $form->input('submit', ['value' => 'Ship!',]) ?></td>
        </tr>
</table>
</form>